...
var getTopThreeTrending = function(callback) {
  var queryString = 'select name, city, venueLocation, state, webId, COUNT(name) AS nameCount from ticketinfo GROUP BY name, city, venueLocation, state, webId ORDER BY COUNT(NAME) desc limit 9;'
